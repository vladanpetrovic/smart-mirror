...
public class ApiReminderApplicationIT {
    ...
    public void contextLoads() {
        ...
        final ResponseEntity<String> dataResponse = this.rest.exchange("/reminders", HttpMethod.GET, new HttpEntity<>(headers), String.class);
        assertEquals(dataResponse.getStatusCode(), HttpStatus.OK);
        assertTrue(dataResponse.getBody().contains("Go to sleep"));
    }
}
