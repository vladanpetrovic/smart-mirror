...
public class ApiDeviceApplicationIT {
    ...
    public void contextLoads() {
        ...
        final ResponseEntity<String> dataResponse = this.rest.exchange("/devices", HttpMethod.GET, new HttpEntity<>(headers), String.class);
        assertEquals(dataResponse.getStatusCode(), HttpStatus.OK);
        assertTrue(dataResponse.getBody().contains("Smart Mirror #1"));
    }
}
