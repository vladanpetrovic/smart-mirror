...
public class ApiUserApplicationIT {
    ...
    public void contextLoads() {
        ...
        final ResponseEntity<String> dataResponse = this.rest.exchange("/users", HttpMethod.GET, new HttpEntity<>(headers), String.class);
        assertEquals(dataResponse.getStatusCode(), HttpStatus.OK);
        assertTrue(dataResponse.getBody().contains("vladan@test.com"));
    }
}
